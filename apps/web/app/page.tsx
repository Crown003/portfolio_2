            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 border-y border-dashed border-slate-200/80 dark:border-slate-800/80">
                  ...
                  <div className="absolute -bottom-6 -right-6 w-36 h-36 pointer-events-none">
                    <svg className="w-full h-full text-slate-300 dark:text-slate-700" viewBox="0 0 100 100" fill="none">
                      <defs>
                        ...
                        <radialGradient id="darkGlobeGrad" cx="50%" cy="50%" r="50%" fx="30%" fy="30%">
                      ...
                      <circle cx="50" cy="50" r="46" className="fill-[url(#darkGlobeGrad)] stroke-slate-300/10 dark:stroke-slate-800/30" strokeWidth="0.5" />

                      <path d="M 4 50 A 46 15 0 0 0 96 50" className="stroke-slate-300/10 dark:stroke-slate-800/40" strokeWidth="0.5" />
                      <path d="M 4 50 A 46 30 0 0 0 96 50" className="stroke-slate-300/15 dark:stroke-slate-800/50" strokeWidth="0.5" />
                      <path d="M 4 50 A 46 15 0 0 1 96 50" className="stroke-slate-300/10 dark:stroke-slate-800/40" strokeWidth="0.5" />
                      <path d="M 4 50 A 46 30 0 0 1 96 50" className="stroke-slate-300/15 dark:stroke-slate-800/50" strokeWidth="0.5" />

                      <path d="M 50 4 A 15 46 0 0 0 50 96" className="stroke-slate-300/10 dark:stroke-slate-800/40" strokeWidth="0.5" />
                      <path d="M 50 4 A 30 46 0 0 0 50 96" className="stroke-slate-300/15 dark:stroke-slate-800/50" strokeWidth="0.5" />
                      <path d="M 50 4 A 15 46 0 0 1 50 96" className="stroke-slate-300/10 dark:stroke-slate-800/40" strokeWidth="0.5" />
                      <path d="M 50 4 A 30 46 0 0 1 50 96" className="stroke-slate-300/15 dark:stroke-slate-800/50" strokeWidth="0.5" />
                  ...
                  <div className="w-full h-full flex flex-col overflow-hidden">
                    ...
                    <div className="w-full h-[320px] sm:h-[350px] md:h-[400px] bg-white relative overflow-hidden">
                      <iframe
                        ...
                        className="absolute top-0 left-0 w-[125%] h-[125%] border-none select-none pointer-events-none scale-80 origin-top-left"
              ...
              <div className="p-6 md:p-8 border-b md:border-r md:border-b-0 lg:border-r border-dashed border-slate-200/80 dark:border-slate-800/80 flex flex-col">
                ...
                >
                  <div className="flex flex-col gap-4 h-full relative z-10 justify-between">
                    {/* Quote Icon */}
                    <span className="text-5xl font-serif text-slate-300 dark:text-slate-800 leading-none select-none">“</span>
                    ...
                    <div className="flex items-center gap-2.5 mt-2">
                      ...
                      <div className="flex flex-col leading-tight">
                        <span className="text-xs font-bold text-foreground">Frank Moore</span>
                        <span className="text-[9px] text-slate-400">VP Engineering, Saasternity</span>
                      </div>
                    </div>
                  </div>
                </Link>
              ...
              <div className="p-6 md:p-8 border-b md:border-none lg:border-r lg:border-b-0 border-dashed border-slate-200/80 dark:border-slate-800/80 flex flex-col">
                ...
                >
                  ...
                  <div className="absolute -bottom-6 -right-6 w-36 h-36 pointer-events-none">
                    <svg className="w-full h-full text-slate-300 dark:text-slate-700" viewBox="0 0 100 100" fill="none">
                      <circle cx="50" cy="50" r="42" stroke="currentColor" strokeWidth="0.5" strokeDasharray="2 2" className="text-slate-200 dark:text-slate-800/40" />
                      <circle cx="50" cy="50" r="28" stroke="currentColor" strokeWidth="0.5" className="text-slate-200 dark:text-slate-800/30" />
                      <path d="M15 50 C 30 30, 70 30, 85 50 C 70 70, 30 70, 15 50 Z" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.15" />
                      <path d="M50 15 C 30 30, 30 70, 50 85 C 70 70, 70 30, 50 15 Z" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.15" />
                      {/* Glowing location indicators */}
                      <circle cx="45" cy="35" r="2.5" className="fill-rose-500 animate-pulse" />
                      <circle cx="65" cy="48" r="3" className="fill-emerald-500 animate-pulse" />
                      <circle cx="30" cy="58" r="2" className="fill-sky-500" />
                      <circle cx="55" cy="65" r="2.5" className="fill-amber-500" />
                    </svg>
                  </div>
                </Link>
              </div>
                  ...
                  <div className="flex flex-col gap-2 relative z-10 h-full justify-between">
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-base font-bold text-white font-display tracking-tight">Saasternity</span>
                      </div>
                      <p className="text-xs text-slate-300 leading-relaxed font-sans font-normal mt-1">
                        Interactive developer tools and scalable SaaS platforms built for the next generation of web engineering.
                      </p>
                    </div>
